...
import com.u.marketapp.databinding.LayoutProduct4Binding
import com.u.marketapp.entity.ProductEntity
import kotlinx.android.synthetic.main.layout_product2.view.image_view_more
import kotlinx.android.synthetic.main.layout_product4.view.*

class HideHistoryRVAdapter : RecyclerView.Adapter<HideHistoryRVAdapter.ViewHolder>() {
    ...
    interface VisibleClickListener { fun onClick(view: View, position: Int) }
    private lateinit var visibleClickListener: VisibleClickListener
    fun setVisibleClickListener(visibleClickListener: VisibleClickListener) {
        this.visibleClickListener = visibleClickListener
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.layout_product4, parent, false)
        )
    }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.apply {
            ...
            itemView.text_view_visible.setOnClickListener { visibleClickListener.onClick(it, position) }
        }
    }
    ...
    class ViewHolder(private val binding: LayoutProduct4Binding) : RecyclerView.ViewHolder(binding.root) {
