...
import com.u.marketapp.databinding.LayoutProduct5Binding
import com.u.marketapp.entity.ProductEntity
import kotlinx.android.synthetic.main.layout_product2.view.*

class PurchaseHistoryRVAdapter : RecyclerView.Adapter<PurchaseHistoryRVAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            DataBindingUtil.inflate(LayoutInflater.from(parent.context), R.layout.layout_product5, parent, false)
        )
    }
    ...
    class ViewHolder(private val binding: LayoutProduct5Binding) : RecyclerView.ViewHolder(binding.root) {
